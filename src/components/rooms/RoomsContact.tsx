  ...
  return (
    <section className="bg-[var(--clr-forest)] px-[24px] py-[60px] lg:px-[80px] lg:py-[100px] border-t border-[rgba(184,150,90,0.15)] flex flex-col lg:flex-row gap-12">
      ...
      <div className="w-full lg:w-[55%]" data-aos="fade-up" data-aos-once="true">
        ...
        <p className="font-['DM_Sans'] text-[16px] text-[var(--clr-smoke)] mt-[20px] max-w-lg">
        ...
        <div className="flex flex-col gap-[16px] mt-[32px]">
          ...
          <div className="flex items-center gap-[12px]">
            ...
            <span className="font-['DM_Sans'] font-medium text-[16px] text-[var(--clr-cream)]">info@alankaaresorts.com
</span>
          </div>
          <div className="flex items-center gap-[12px]">
      ...
      <div className="w-full lg:w-[45%] flex flex-col gap-[16px] justify-center" data-aos="fade-up" data-aos-delay="200" data-aos-once="true">
        <button onClick={() => navigate('/booking')} className="inline-block w-full bg-[var(--clr-gold)] text-[var(--clr-void)] font-['Jost'] text-[12px] uppercase py-[20px] px-[48px] text-center tracking-[0.15em] hover:bg-[var(--clr-gold-light)] transition-colors">
        ...
        <a href="mailto:info@alankaaresorts.com" target="_blank" rel="noopener noreferrer" className="flex items-center w-full justify-center gap-2 bg-transparent border border-[rgba(184,150,90,0.3)] text-[var(--clr-gold)] font-['Jost'] text-[12px] uppercase py-[20px] px-[48px] text-center hover:bg-[rgba(184,150,90,0.05)] transition-colors">
