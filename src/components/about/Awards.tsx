          ...
          {awards.map((award, idx) => {
            ...
            return (
              ...
              >
                ...
                <h4 className="font-dmSans font-light tracking-wide text-[18px] text-cream mb-2 relative z-10">
                  {award.name}
                </h4>
                <p className="font-jost text-[15px] text-gold uppercase tracking-[0.2em] opacity-90 relative z-10">
                  {award.source}
                </p>
              </div>
            );
